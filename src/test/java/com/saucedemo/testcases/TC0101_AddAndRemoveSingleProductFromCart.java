...
public class TC0101_AddAndRemoveSingleProductFromCart extends BaseTest {

	@Test(dataProvider = "getTestData")
	public void run(String user, String product1) {
		log.info("~~~~~ Add and Remove single product from the cart in the Products (Home) Page.");
		...
		log.info(String.format("~~~~~ Product: %s is added to cart.", product1));
		homePage.removeProductFromCart(product1);
		log.info(String.format("~~~~~ Product: %s is removed from cart.", product1));
